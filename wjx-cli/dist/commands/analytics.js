...
export function registerAnalyticsCommands(program) {
    ...
    analytics
        ...
        try {
            ...
            const result = decodeResponses(m.submitdata);
    ...
    analytics
        ...
        try {
            ...
            const result = calculateCsat(scores, m.scale);
            formatOutput(result, program.opts());
        }
        catch (e) {
            handleError(e);
    ...
    analytics
        ...
        try {
            ...
            const setA = JSON.parse(m.set_a);
            const setB = JSON.parse(m.set_b);
    ...
    analytics
        ...
        try {
            ...
            const result = decodePushPayload(m.payload, m.app_key, m.signature, m.raw_body);
            formatOutput(result, program.opts());
        }
        catch (e) {
            handleError(e);
