...
当前稳定版本以各自 `package.json` 为准：SDK 0.4.3、MCP Server 0.4.3、CLI 0.4.3；均已发布到 npm，发布顺序为 SDK → MCP Server → CLI。
...
- Commander.js（CLI 框架）
- wjx-api-sdk（发布依赖固定为 `"wjx-api-sdk": "^0.4.3"`；monorepo 开发时由 workspace 解析）
