...
当前源码版本以各自 `package.json` 为准：SDK 0.4.5、MCP Server 0.4.5、CLI 0.4.5；发布顺序为 SDK → MCP Server → CLI。
...
- Commander.js（CLI 框架）
- wjx-api-sdk（发布依赖固定为 `"wjx-api-sdk": "^0.4.5"`；monorepo 开发时由 workspace 解析）
