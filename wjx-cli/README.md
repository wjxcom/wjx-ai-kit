...
wjx dsl query --vid <vid>                # 查询传统 vid 并返回完整 DSL
wjx dsl create --file q.wjx              # 创建问卷
wjx dsl update --vid <vid> --file q.wjx # 修改问卷
wjx survey create-by-json --file q.jsonl # 显式 JSONL 兼容路径
wjx survey create-by-text --text "..."   # 显式旧文本 DSL 兼容路径
wjx survey create --title "新问卷"         # 旧 JSON 数组兼容路径
