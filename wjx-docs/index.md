...
当前版本提供 MCP **61 个 Tool**、**8 个 Resource**、**15 个 Prompt**，以及 CLI **77 个叶子命令**；SDK 的公开导出以 [SDK API 参考](reference/sdk.md) 为准。CLI 是主入口，MCP 只保证核心业务子集；完整差异见仓库 `capabilities/capability-matrix.json`。
