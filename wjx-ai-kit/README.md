...
// 创建问卷
const result = await createSurvey({ title: "客户满意度调查" }, creds);
```
...
npm test --workspace=wjx-cli          # CLI tests
```
...
欢迎贡献！请参阅 [wjx-mcp-server/CONTRIBUTING.md](wjx-mcp-server/CONTRIBUTING.md) 了解贡献指南。
