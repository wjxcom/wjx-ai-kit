...
```
格式: 题号$答案}题号$答案
分隔符: } 分隔题目, $ 分隔题号和答案, | 分隔多选选项, , 分隔排序题选项
...
示例:
  ...
  填空: 3$答案文本
  量表: 4$8          (第4题选8分)
  排序: 5$2,3,1      (第5题排序：选项2第1名、选项3第2名、选项1第3名)
  矩阵: 6_1$1}6_2$3  (第6题矩阵子题1选1、子题2选3，格式：题号_子题序号$值)
  比重: 7_1$33}7_2$67 (第7题子项1分配33%、子项2分配67%)
  滑动条: 8$59       (第8题滑动条选59分)
  多项填空: 9_1$文本1}9_2$文本2 (第9题填空位1填文本1、位2填文本2)
  多级下拉: 10$中国-湖南 (各级用-连接)
```
