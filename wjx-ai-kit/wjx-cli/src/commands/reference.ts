...
## wjx response submit
  ...
  示例：
    ...
    多选："3$1|3" = 第3题选A和C
    排序："4$2,3,1" = 第4题排序：选项B第1名、选项C第2名、选项A第3名（按排名顺序用英文逗号分隔所有选项序号）
    矩阵题："5_1$1}5_2$3" = 第5题矩阵子题1选1、子题2选3（格式：题号_子题序号$值）
    比重题："6_1$33}6_2$67" = 第6题子项1分配33%、子项2分配67%
    滑动条："7$59" = 第7题滑动条选59分
    多项填空："8_1$文本1}8_2$文本2" = 第8题第1个填空填文本1、第2个填文本2
    多级下拉："9$中国-湖南" = 第9题选中国→湖南（各级用-连接）
