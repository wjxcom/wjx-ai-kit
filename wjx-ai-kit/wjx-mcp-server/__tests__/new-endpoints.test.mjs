...
const TEST_CREDENTIALS = { appId: "test-app", appKey: "test-key" };
...
test("queryResponses", async (t) => {
  await t.test("should POST with action 1001002 and vid", async () => {
    ...
    await queryResponses({ vid: 12345 }, TEST_CREDENTIALS, mock.impl, "1700000000");
  ...
  await t.test("should not include undefined optional fields", async () => {
    const mock = mockFetch({ result: true, data: {} });
    await queryResponses({ vid: 100 }, TEST_CREDENTIALS, mock.impl);
  ...
  await t.test("should return parsed response", async () => {
    ...
    const result = await queryResponses({ vid: 100 }, TEST_CREDENTIALS, mock.impl);
...
test("queryResponsesRealtime", async (t) => {
  await t.test("should POST with action 1001003 and vid", async () => {
    const mock = mockFetch({ result: true, data: [] });
    await queryResponsesRealtime({ vid: 200 }, TEST_CREDENTIALS, mock.impl, "1700000000");
  ...
  await t.test("should include count parameter", async () => {
    const mock = mockFetch({ result: true, data: [] });
    await queryResponsesRealtime({ vid: 200, count: 10 }, TEST_CREDENTIALS, mock.impl);
  ...
  await t.test("should not include count when undefined", async () => {
    const mock = mockFetch({ result: true, data: [] });
    await queryResponsesRealtime({ vid: 200 }, TEST_CREDENTIALS, mock.impl);
...
test("downloadResponses", async (t) => {
  await t.test("should POST with action 1001004 and vid", async () => {
    ...
    await downloadResponses({ vid: 300 }, TEST_CREDENTIALS, mock.impl, "1700000000");
  ...
  await t.test("should include taskid for polling", async () => {
    ...
    await downloadResponses({ vid: 300, taskid: 12345 }, TEST_CREDENTIALS, mock.impl);
...
test("getReport", async (t) => {
  await t.test("should POST with action 1001101 and vid", async () => {
    ...
    await getReport({ vid: 400 }, TEST_CREDENTIALS, mock.impl, "1700000000");
  ...
  await t.test("should not include undefined optional fields", async () => {
    const mock = mockFetch({ result: true, data: {} });
    await getReport({ vid: 400 }, TEST_CREDENTIALS, mock.impl);
...
test("getSurveySettings", async (t) => {
  await t.test("should POST with action 1000003 and vid", async () => {
    ...
    await getSurveySettings({ vid: 500 }, TEST_CREDENTIALS, mock.impl, "1700000000");
  ...
  await t.test("should return parsed settings response", async () => {
    ...
    const mock = mockFetch(responseData);
    const result = await getSurveySettings({ vid: 500 }, TEST_CREDENTIALS, mock.impl);
...
test("getQuestionTags", async (t) => {
  await t.test("should POST with action 1000004 and username", async () => {
    const mock = mockFetch({ result: true, data: [] });
    await getQuestionTags({ username: "testuser" }, TEST_CREDENTIALS, mock.impl, "1700000000");
  ...
  await t.test("should return tag list", async () => {
    ...
    const mock = mockFetch(responseData);
    const result = await getQuestionTags({ username: "testuser" }, TEST_CREDENTIALS, mock.impl);
