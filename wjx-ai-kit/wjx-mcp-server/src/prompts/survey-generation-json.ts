 ...
 * Ensures AI output is compatible with the jsonToSurvey parser.
 */
...
考试多项填空：{"qtype":"考试多项填空","title":"________填空1________填空2","answerlists":[{"correctselect":["答案"],"quizscore":"2","include":true}],"answeranalysis":"解析..."}
