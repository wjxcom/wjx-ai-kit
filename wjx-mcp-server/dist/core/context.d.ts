...
import type { WjxCredentials } from "./types.js";
/**
 ...
 */
export declare const credentialStore: AsyncLocalStorage<WjxCredentials>;
/** Return request-scoped credentials, or `undefined` if not in an HTTP context. */
export declare function getRequestCredentials(): WjxCredentials | undefined;
