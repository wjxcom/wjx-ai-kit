import { SURVEY_TYPES, QUESTION_TYPES, SURVEY_STATUSES, VERIFY_STATUSES, STATUS_TRANSITIONS, } from "./survey-reference.js";
...
export function registerResources(server) {
    ...
    server.resource("survey-statuses", "wjx://reference/survey-statuses", { description: "问卷状态编码说明：0=未发布, 1=已发布, 2=已暂停, 3=已删除, 4=彻底删除, 5=被审核", mimeType: "application/json" }, async () => ({
        contents: [{
