import { z } from "zod";
import { createSurvey, createSurveyByText, getSurvey, listSurveys, updateSurveyStatus, getSurveySettings, updateSurveySettings, deleteSurvey, getQuestionTags, getTagDetails, clearRecycleBin, uploadFile, surveyToText, } from "./client.js";
...
export function registerSurveyTools(server) {
    ...
    server.registerTool("create_survey_by_text", {
        title: "用 DSL 文本创建问卷",
        description: "通过人类可读的 DSL 文本创建问卷。文本格式与 get_survey(format='dsl') 输出一致。" +
