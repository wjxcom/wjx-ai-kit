  ...
  server.registerTool(
    "query_responses",
    {
      ...
      inputSchema: {
        ...
        begin_time: z.number().optional().describe("查询开始时间（Unix毫秒时间戳）"),
        end_time: z.number().optional().describe("查询结束时间（Unix毫秒时间戳）"),
  ...
  server.registerTool(
    "modify_response",
    {
      ...
      inputSchema: {
        ...
        type: z.number().int().describe("修改类型：1=修改分数（目前仅支持1）"),
