  ...
  server.registerTool(
    "create_survey_by_json",
    {
      ...
      description:
        ...
        "【禁用题型】所有类型的问卷在创建或编辑时都禁止使用以下题型：表格数值、表格组合、表格填空、表格下拉框、自增表格。" +
        "需要多字段录入时，请改用单项填空、多项填空、多项文件题(711) 或多项简答题(712)。" +
        "其中多项文件题(711) 用 rowtitle 列出每个上传项；多项简答题(712) 用 rowtitle 列出每个简答子题。" +
        "输入示例（JSONL）：\n" +
        '{"qtype":"问卷基础信息","title":"客户满意度调查","introduction":"请认真填写"}\n' +
        '{"qtype":"单选","title":"您的性别","select":["男","女"]}\n' +
        '{"qtype":"多项填空","title":"联系方式：电话 {_}，邮箱 {_}"}\n' +
        '{"qtype":"多项简答题","title":"团队成员说明","rowtitle":["成员1介绍","成员2介绍"]}\n' +
