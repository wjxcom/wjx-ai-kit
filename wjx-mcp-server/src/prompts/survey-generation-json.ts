...
7. 【矩阵题特别说明】qtype 必须使用具体子类型，**禁止使用模糊值**如「矩阵」「矩阵题」「矩阵评分」「通用矩阵」「表格题」等 — 服务端会创建失败或退化为单选题。当用户说"包含全部矩阵题型"时，应理解为下列已支持的子类型（共 12 种，对应 q_subtype=701..712），不要凭想象造新名字：
   ...
   - 表格填空题：{"qtype":"表格填空题","title":"填写明细","rowtitle":["第一项","第二项"]}
   - 表格下拉框：{"qtype":"表格下拉框","title":"选择选项","rowtitle":["行1","行2"],"select":["A","B","C"]}
   - 表格组合题：{"qtype":"表格组合题","title":"综合评价","rowtitle":["维度A","维度B"],"select":["列1","列2"]}
   - 表格自增题：{"qtype":"表格自增题","title":"家庭成员","rowtitle":["姓名","年龄","关系"]}
   - 多项文件题：{"qtype":"多项文件题","title":"上传多份文件","rowtitle":["证件照","身份证正面","身份证反面"]}
   - 多项简答题：{"qtype":"多项简答题","title":"请分别回答","rowtitle":["问题1","问题2","问题3"]}
