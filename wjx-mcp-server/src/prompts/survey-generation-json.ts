...
/** Survey 支持的 qtype 列表（覆盖 atype∈{1,2,3,10,11} 情形，含专业调查模型） */
...
const FORM_QTYPES = "单选、多选、下拉框、文件上传、单项填空、简答题、多项填空、矩阵填空、多级下拉、门店选择、签名题、地图、日期、AI追问、AI处理、分页栏、段落说明、折叠栏目、轮播图、表格数值、表格组合、表格填空、表格下拉框、自增表格、图片OCR、商品题、预约题、姓名、基本信息、身份证号、国家及地区、省市、省市区、邮箱、手机、手机验证、时间、高校、邮寄地址、企业信息、知情同意书、密码";
...
export function registerSurveyGenerationJsonPrompts(server: McpServer): void {
  ...
  server.prompt(
    ...
    "AI 用 JSONL 格式生成调查/测评/投票/量表/民主测评问卷（支持 60+ 题型，含 BWS/MaxDiff/联合分析/Kano/PSM 等专业模型），自动创建到问卷星",
    {
      topic: z.string().describe("问卷主题（如：品牌偏好调研、员工满意度测评、投票选举、民主测评）"),
