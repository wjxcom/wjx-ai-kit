...
8. 【必答规则】默认所有题目都是必答题。除非用户明确要求“选填/可选/非必答”，否则不要输出 \`requir:false\`。简答题、意见建议题、开放题默认也必须是必答题
...
/** Form 支持的 qtype 列表（对齐服务端官方 "7" prompt 白名单，不含 BWS/MaxDiff/Kano/PSM 等调查专业模型） */
const FORM_QTYPES = "单选、多选、下拉框、文件上传、单项填空、简答题、多项填空、矩阵填空、多级下拉、门店选择、签名题、地图、日期、AI追问、AI处理、分页栏、段落说明、折叠栏目、轮播图、图片OCR、商品题、预约题、姓名、基本信息、身份证号、国家及地区、省市、省市区、邮箱、手机、手机验证、时间、高校、邮寄地址、企业信息、知情同意书、密码、多项文件题、多项简答题";

const FORM_BLOCKED_QTYPE_NOTICE = "表单类型禁止使用以下题型：表格数值、表格组合、表格填空、表格下拉框、自增表格。需要多字段录入时，请改用单项填空、多项填空、多项文件题或多项简答题。";
