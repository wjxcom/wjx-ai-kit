...
export const QUESTION_TYPES: Record<number, { name: string; subtypes?: Record<number, string> }> = {
  ...
  6: {
    name: "多项填空题",
    subtypes: { 6: "普通多项填空", 601: "考试多项填空", 602: "考试完形填空" },
  },
  7: {
    name: "矩阵题",
    subtypes: { 7: "矩阵题", 701: "矩阵量表题", 702: "矩阵单选题", 703: "矩阵多选题", 704: "矩阵填空题", 705: "矩阵滑动条", 706: "矩阵数值题", 707: "表格填空题", 708: "表格下拉框", 709: "表格组合题", 710: "表格自增题", 711: "多项文件题", 712: "多项简答题" },
  },
  8: {
    name: "文件上传",
