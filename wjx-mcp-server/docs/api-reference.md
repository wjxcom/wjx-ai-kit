...
| --- | --- | --- | --- | --- |
| vid | number | 是 | - | 问卷编号 |
| additional_setting | string | 否 | "[1000,1001,1002,1003,1004,1005,1006,1007]" | 要获取的设置类别 JSON 数组字符串。默认获取全部：1000=基本信息, 1001=提交后设置, 1002=时间设置, 1003=消息推送, 1004=参数设置, 1005=API设置, 1006=数据推送, 1007=文件夹 |
...
- `analytics` 模块中的 58 个工具均为本地计算，不依赖远程 OpenAPI 可用性。
