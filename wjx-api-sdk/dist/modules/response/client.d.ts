...
export declare function submitResponse<T = unknown>(input: SubmitResponseInput, credentials?: WjxCredentials, fetchImpl?: FetchLike, requestOptions?: RequestOverrides): Promise<WjxApiResponse<T>>;
