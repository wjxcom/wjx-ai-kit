export declare function getWjxBaseUrl(baseUrl?: string): string;
export declare function getWjxApiUrl(baseUrl?: string): string;
...
export declare function getWjxSurveyCreateUrl(baseUrl?: string): string;
export declare function getWjxSurveyEditUrl(baseUrl?: string): string;
