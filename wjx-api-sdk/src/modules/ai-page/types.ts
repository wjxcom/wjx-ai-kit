/** Input for creating an AI homepage through OpenAPI action 1000107. */
export interface CreateAiPageInput {
  /** AI homepage HTML. Either html_content or the compatibility html field is required. */
  html_content?: string;
...
/** Input for updating an AI homepage through OpenAPI action 1000108. */
